...
class StringBundlePropertyTest {

    var Bundle.named: String by bundleString("test", "0")
    var Bundle.default: String by bundleString(default = "3")
    var Bundle.optional: String? by bundleString()
