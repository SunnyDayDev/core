...
class LongBundlePropertyTest {

    var Bundle.named: Long by bundleLong("test", 0)
    var Bundle.default: Long by bundleLong(default = 3)
    var Bundle.optional: Long? by bundleLong()
